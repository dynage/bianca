...
query_sub_idx = test_subs_idx
run_bianca(bianca_dir, wd_dir, crash_dir, n_cpu=n_cpu, save_classifier=False,
           trained_classifier_file=clf_file, training_subject_idx=training_subs_idx,
